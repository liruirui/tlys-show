    ...
    (function ($, undefined) {
        ...
        $.widget("mobile.pagecontainer", {
            ...
            load: function (url, options) {
                ...
                if (content.length === 0 &&
                    $.mobile.path.isEmbeddedPage(fileUrl) && !$.mobile.path.isFirstPageUrl(fileUrl)) {
            ...
            transition: function (toPage, triggerData, settings) {
                ...
                if (isDialog && active) {
                    ...
                    if (active.url &&
                        ...
                        this.activePage && !this.activePage.hasClass("ui-dialog") &&
    ...
    (function ($, undefined) {
        ...
        $.mobile._registerInternalEvents = function () {
            ...
            $.mobile.document.bind("vclick", function (event) {
                ...
                if ($btn.length > 0 && !( $btn.hasClass("ui-state-disabled" ||
        ...
        $.widget("mobile.textinput", {
            ...
            _create: function () {
                ...
                var options = this.options,
                    ...
                    this.element.is("[data-" + ( $.mobile.ns || "" ) + "type='search']") ) && !isRange );
            ...
            _setOptions: function (o) {
                if (o.addBackBtn !== undefined) {
                    if (this.options.addBackBtn &&
                        this.role === "header" &&
                        $(".ui-page").length > 1 &&
                        this.page[0].getAttribute("data-" + $.mobile.ns + "url") !== $.mobile.path.stripHash(location.hash) && !this.leftbtn) {
                        this._addBackButton();
                    } else {
